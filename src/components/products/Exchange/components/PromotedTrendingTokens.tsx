...
import { usePromotedTrendingTokens } from '@app/state/exchange'
...
export default function PromotedTrendingTokens() {
    const list = usePromotedTrendingTokens()
    return (
        <div className="rounded-2xl bg-[#001926] p-4 h-full">
            <div className="text-[18px] md:text-[24px] text-white my-3">
                Top Promoted Trending Tokens
            </div>
